...
def train_wgan(X_train, noise_dim=100, batch_size=128, epochs=100):
...
y_train_augmented = np.hstack([y_train, np.random.choice(y_train, 1000)])
...
plt.title(f"Test Confusion Matrix - RandomForest")
plt.show()

# Print accuracy and classification report
print(f"Test Accuracy: {accuracy_test:.7f}")
